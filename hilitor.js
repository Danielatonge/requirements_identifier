...
function Hilitor(id, tag)
{
  ...
  var colors = ["#9f9", "#f99", "#f6f", "#ff6", "#a0ffff"];
  var wordColor = [];
  var colorIdx = 0;
  var matchRegExp = "";
  var openLeft = false;
...
var requirements = ["extensions", "must", "shall", "free"];
requirements.forEach(element => {
    if(myHilitor.apply(element)) {
...
button_two.innerHTML = "Wrong";

// 2. Append somewhere
var body = document.getElementsByTagName("body")[0];
body.appendChild(button);
body.appendChild(button_two);